...
const SwipeableGrid = () => {
  ...
  return (
    <section className="bg-[#F5F0A0] rounded-4xl max-w-6xl mx-auto pt-6 pb-10 px-4 relative">
        ...
        >
          ...
          >
            ...
            <img
              ...
              className="w-full max-h-full object-contain touch-pan-y cursor-zoom-in"
              draggable="false"
              onDoubleClick={(e) => {
                const el = e.target;
                if (document.fullscreenElement) {
